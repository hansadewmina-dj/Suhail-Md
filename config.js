...
global.appUrl=process.env.APP_URL || "https://api-smd-1.vercel.app"                       // put your app url here,
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://raw.githubusercontent.com/hansadewmina-dj/Suhail-Md/main/lib/assets/Black%20%26%20White%20Minimalist%20Business%20Logo(3).png" ; // SET LOGO FOR IMAGE 
global.caption = process.env.CAPTION || global.caption || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ DEWMINA²²¹-ᴍᴅ" 


global.devs = "94701515609" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "null";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "94701515609";
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ DEWMINA²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • DEWMINA ᴛᴇᴄʜ』*\n youtube.com/@Dj_Dewmina"),
 
  author : process.env.PACK_AUTHER|| "",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "DEWMINA-MD",
  ...
  LANG: ( process.env.THEME ||  "DEWMINA"  ).toUpperCase(),
